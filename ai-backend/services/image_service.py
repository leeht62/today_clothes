...
async def generate_image_from_prompt(input_data: SimpleInput):
    ...
    messages=[
        ...
        {"role": "user", "content": f"Recommend a detailed and trendy outfit that you would typically see in Hongdae, with a stylish and hip urban street style vibe. Only return the English outfit description. Scene: {input_data.prompt}"}
    ],
    temperature=0.5
    )
