...
async def generate_image_from_prompt(input_data: SimpleInput):
    ...
    messages=[
        ...
        {"role": "user", "content": f"Recommend a detailed and trendy outfit combination using Levi’s denim shirts, Polo linen shirts, jeans, and cotton pants, based on the current weather. The style should reflect what you would typically see in Hongdae — stylish, hip, and urban. Only return the English outfit description. Scene: {input_data.prompt}"}
    ],
    temperature=0.5
    )
